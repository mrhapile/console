...
- **Completed**:
  ...
  - ✅ PR/Issue templates
  - ✅ OWNERS + labeler.yml
  - ✅ GitHub App OAuth (multi-environment support)
  - ✅ Fixed OAuth redirect URL for cluster deployment
  - ✅ Fixed header size limit (Fiber ReadBufferSize)
  - ✅ Fixed kubectl action in CI (v3.2)
  - ✅ Deployed to vllm-d cluster
  - ✅ .env file support for local dev
  - ✅ Netlify preview deployment setup (netlify.toml + MSW demo mode)
...
- **Completed**:
  ...
  - ✅ Fixed all auth mocking issues in tests
  - ✅ Created PR #1 with test infrastructure
...
### From playwright → kkc (2026-01-16 08:50)
...
### From infra → kkc (2026-01-16 08:10)
