        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div>
              ...
              <p className="text-muted-foreground">Monitor Kubernetes services and network connectivity</p>
            </div>
            {isRefreshing && (
          ...
          <div className="flex items-center gap-3">
            <label htmlFor="services-auto-refresh" className="flex items-center gap-1.5 cursor-pointer text-xs text-muted-foreground" title="Auto-refresh every 30s">
              <input
                type="checkbox"
                id="services-auto-refresh"
                checked={autoRefresh}
