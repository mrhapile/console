  ...
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    <defs>
      <linearGradient id="eksGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="var(--provider-eks-start)" />
        <stop offset="100%" stopColor="var(--provider-eks)" />
      </linearGradient>
    </defs>
    {/* Outer hexagon */}
    ...
    {/* K letter */}
    <text x="12" y="15" textAnchor="middle" fill="var(--provider-eks)" fontSize="9" fontWeight="bold" fontFamily="Arial, sans-serif">K</text>
  </svg>
)
...
const GCPIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <path d="M12 2 L20 6.5 Q22 8 22 10 L22 14 Q22 16 20 17.5 L12 22 L4 17.5 Q2 16 2 14 L2 10 Q2 8 4 6.5 Z" fill="var(--provider-gke)" />
  ...
  <svg viewBox="0 0 16 16" width={size} height={size} className={className}>
    <defs>
      <linearGradient id="aksGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="var(--provider-aks-start)" />
        <stop offset="100%" stopColor="var(--provider-aks)" />
      </linearGradient>
    </defs>
    {/* Top row - 2 cubes */}
    <path fill="url(#aksGradient1)" d="M5.5 2l-2.2.4v3l2.2.5 2.2-.9V2.8L5.5 2z"/>
    <path fill="var(--provider-aks-shadow)" d="M3.3 2.4v3l2.2.5V2l-2.2.4zm.9 2.8l-.6-.1V2.8l.6-.1v2.5zm1 .2l-.7-.1V2.6l.7-.1v2.9z"/>
    <path fill="url(#aksGradient1)" d="M10.3 2l-2.2.4v3l2.2.5 2.2-.9V2.8L10.3 2z"/>
    <path fill="var(--provider-aks-shadow)" d="M8.1 2.5v3l2.2.5V2l-2.2.4zm.9 2.8l-.6-.1V2.8l.6-.1v2.5zm1 .2l-.7-.1V2.6l.7-.1v2.9z"/>
    {/* Middle row - 3 cubes */}
    <path fill="url(#aksGradient1)" d="M3.2 6.2l-2.2.4v3l2.2.5 2.2-.9V7L3.2 6.2z"/>
    <path fill="var(--provider-aks-shadow)" d="M1 6.6v3l2.2.5V6.2L1 6.6zm.9 2.8l-.6-.1V6.9l.6-.1v2.6zm1 .2l-.7-.1V6.8l.7-.1v2.9z"/>
    <path fill="url(#aksGradient1)" d="M8 6.2l-2.2.4v3l2.2.5 2.2-.9V6.9L8 6.2z"/>
    <path fill="var(--provider-aks-shadow)" d="M5.8 6.6v3l2.2.5V6.2l-2.2.4zm.9 2.8l-.6-.1V6.9l.6-.1v2.6zm1 .2l-.7-.1V6.8l.7-.1v2.9z"/>
    <path fill="url(#aksGradient1)" d="M12.8 6.2l-2.2.4v3l2.2.5 2.2-.9V7l-2.2-.8z"/>
    <path fill="var(--provider-aks-shadow)" d="M10.6 6.6v3l2.2.5V6.2l-2.2.4zm1 2.8l-.6-.1V6.9l.6-.1v2.6zm1 .2l-.7-.1V6.8l.7-.1v2.9z"/>
    {/* Bottom row - 2 cubes */}
    <path fill="url(#aksGradient1)" d="M5.5 10.4l-2.2.4v3l2.2.5 2.2-.9v-2.3l-2.2-.7z"/>
    <path fill="var(--provider-aks-shadow)" d="M3.2 10.8v3l2.2.5v-4l-2.2.5zm1 2.8l-.6-.1v-2.3l.6-.1v2.5zm1 .2l-.7-.1v-2.7l.7-.1v2.9z"/>
    <path fill="url(#aksGradient1)" d="M10.3 10.4l-2.2.4v3l2.2.5 2.2-.9v-2.3l-2.2-.7z"/>
    <path fill="var(--provider-aks-shadow)" d="M8 10.9v3l2.2.5v-3.9l-2.2.4zm1 2.8l-.6-.1v-2.3l.6-.1v2.5zm1 .2l-.7-.1v-2.7l.7-.1v2.9z"/>
  </svg>
)
...
const OpenShiftIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} className={className}>
    ...
    <rect x="5" y="28" width="90" height="12" rx="2" fill="var(--provider-openshift)" transform="rotate(-10 50 34)" />
    {/* Bottom horizontal bar with slight tilt */}
    <rect x="5" y="60" width="90" height="12" rx="2" fill="var(--provider-openshift)" transform="rotate(-10 50 66)" />
    {/* Main red O ring */}
    <circle cx="50" cy="50" r="35" fill="var(--provider-openshift)" />
    {/* White center hole */}
    <circle cx="50" cy="50" r="18" fill="white" />
    {/* Darker overlap areas on top bar */}
    <path d="M15 28 L38 28 L38 40 L15 40 Z" fill="var(--provider-openshift-dark)" transform="rotate(-10 50 34)" />
    <path d="M62 28 L85 28 L85 40 L62 40 Z" fill="var(--provider-openshift-dark)" transform="rotate(-10 50 34)" />
    {/* Darker overlap areas on bottom bar */}
    <path d="M15 60 L38 60 L38 72 L15 72 Z" fill="var(--provider-openshift-dark)" transform="rotate(-10 50 66)" />
    <path d="M62 60 L85 60 L85 72 L62 72 Z" fill="var(--provider-openshift-dark)" transform="rotate(-10 50 66)" />
  </svg>
)
...
const OCIIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    <rect width="24" height="24" rx="4" fill="var(--provider-oci)" />
...
const AlibabaIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <polygon points="12,2 21,7 21,17 12,22 3,17 3,7" stroke="var(--provider-alibaba)" strokeWidth="2" fill="none" />
    {/* Inner hexagon */}
    <polygon points="12,6 17,9 17,15 12,18 7,15 7,9" stroke="var(--provider-alibaba)" strokeWidth="1.5" fill="none" />
    {/* Center cube */}
    <rect x="10" y="10" width="4" height="4" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Top node */}
    <rect x="10.5" y="4" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Top-right node */}
    <rect x="16" y="7" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Bottom-right node */}
    <rect x="16" y="14" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Bottom node */}
    <rect x="10.5" y="17" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Bottom-left node */}
    <rect x="5" y="14" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Top-left node */}
    <rect x="5" y="7" width="3" height="3" fill="var(--provider-alibaba)" rx="0.5" />
    {/* Connecting lines */}
    <line x1="12" y1="7" x2="12" y2="10" stroke="var(--provider-alibaba)" strokeWidth="1" />
    <line x1="14" y1="11" x2="16" y2="9" stroke="var(--provider-alibaba)" strokeWidth="1" />
    <line x1="14" y1="13" x2="16" y2="15" stroke="var(--provider-alibaba)" strokeWidth="1" />
    <line x1="12" y1="14" x2="12" y2="17" stroke="var(--provider-alibaba)" strokeWidth="1" />
    <line x1="10" y1="13" x2="8" y2="15" stroke="var(--provider-alibaba)" strokeWidth="1" />
    <line x1="10" y1="11" x2="8" y2="9" stroke="var(--provider-alibaba)" strokeWidth="1" />
  </svg>
)
...
const DigitalOceanIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <path
      ...
      fill="var(--provider-digitalocean)"
    />
    {/* Bottom right square pixels */}
    <rect x="12" y="16" width="4" height="4" fill="var(--provider-digitalocean)" />
    <rect x="16" y="12" width="4" height="4" fill="var(--provider-digitalocean)" />
    {/* Small pixel squares */}
    <rect x="17" y="8" width="2" height="2" fill="var(--provider-digitalocean)" />
    <rect x="19" y="10" width="1.5" height="1.5" fill="var(--provider-digitalocean)" />
    <rect x="15" y="6" width="1.5" height="1.5" fill="var(--provider-digitalocean)" />
  </svg>
)
...
const RancherIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <rect width="24" height="24" rx="4" fill="var(--provider-rancher)" />
    ...
    {/* Left eye */}
    <circle cx="9.5" cy="10" r="1.2" fill="var(--provider-rancher)" />
    {/* Right eye */}
    <circle cx="14.5" cy="10" r="1.2" fill="var(--provider-rancher)" />
    {/* Nose/snout */}
    <ellipse cx="12" cy="14.5" rx="3" ry="2" fill="var(--provider-rancher)" fillOpacity="0.3" />
    {/* Nostrils */}
    <circle cx="10.5" cy="14.5" r="0.6" fill="var(--provider-rancher)" />
    <circle cx="13.5" cy="14.5" r="0.6" fill="var(--provider-rancher)" />
  </svg>
)
  ...
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    <defs>
      <linearGradient id="cwGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="var(--provider-coreweave-start)" />
        <stop offset="100%" stopColor="var(--provider-coreweave)" />
      </linearGradient>
    </defs>
    {/* Background */}
...
const MinikubeIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <polygon
      ...
      fill="none"
      stroke="var(--provider-kubernetes)"
      strokeWidth="1.5"
    />
    ...
    <path d="M6 7 L12 4 L18 7 L18 11 L12 14 L6 11 Z" fill="var(--provider-minikube-teal-light)" />
    <path d="M12 4 L12 8 L6 11 L6 7 Z" fill="var(--provider-minikube-teal)" />
    <path d="M12 4 L12 8 L18 11 L18 7 Z" fill="var(--provider-minikube-teal-lighter)" />
    {/* Helm wheel - blue */}
    <circle cx="12" cy="16" r="4" fill="none" stroke="var(--provider-kubernetes)" strokeWidth="1.5" />
    <circle cx="12" cy="16" r="1" fill="var(--provider-kubernetes)" />
    {/* Helm spokes */}
    <line x1="12" y1="12" x2="12" y2="14.5" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="12" y1="17.5" x2="12" y2="20" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="8" y1="16" x2="10.5" y2="16" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="13.5" y1="16" x2="16" y2="16" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    {/* Diagonal spokes */}
    <line x1="9.2" y1="13.2" x2="10.8" y2="14.8" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="13.2" y1="17.2" x2="14.8" y2="18.8" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="14.8" y1="13.2" x2="13.2" y2="14.8" stroke="var(--provider-kubernetes)" strokeWidth="1" />
    <line x1="10.8" y1="17.2" x2="9.2" y2="18.8" stroke="var(--provider-kubernetes)" strokeWidth="1" />
  </svg>
)
...
const K3sIcon: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} className={className}>
    ...
    <rect width="24" height="24" rx="5" fill="var(--provider-k3s)" />
