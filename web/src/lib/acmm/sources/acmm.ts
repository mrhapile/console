...
const LEVELS: LevelDef[] = [
  {
    ...
    name: 'Prerequisites',
    role: '',
    characteristic: 'Standard software engineering practices that AI development practices build on. These are not AI-specific but are required for the maturity levels to function.',
  ...
  },
  {
    ...
    role: 'Executor',
    characteristic: 'AI used opportunistically. Developers run Claude Code, Copilot, or Cursor without project-specific configuration. Each session starts from scratch with no shared context.',
  ...
  },
  {
    ...
    name: 'Instructed',
    role: 'Rule-writer',
    characteristic: 'AI receives project context through committed files. Every session starts with the same understanding of the project\'s conventions, architecture, and expectations.',
  ...
  },
  {
    ...
    role: 'Analyst',
    characteristic: 'Rules are mechanically enforced, not just instructed. Violations are caught by hooks, CI, permission gates, and layered safety. The team instruments the AI loop with PR acceptance rate, coverage, review density.',
  ...
  },
  {
    ...
    role: 'Governor',
    characteristic: 'Workflows are structured, repeatable, and environment-aware. The AI follows decision trees rather than improvising. The loop closes: metrics feed back into instructions, review rules, and gating thresholds automatically.',
